...
description: |
  Recopilando trucos/ejemplos de CSS, SASS, ...
---
...
:::
::: {.column width="35%"}
- El fichero `my_styles.css` sería así:
...
- Para hacerlo sin utilizar `my_styles.css`. Se haría utilizando un `div` así:
...
- [Styling and Templating Quarto Documents](https://emilhvitfeldt.com/talk/2023-09-19-quarto-theming-positconf/) tiene varios ejemplos: colores, fuentes y como hacer una template

- [Aquí](https://quarto.org/docs/presentations/revealjs/themes.html#sass-variables) tienes las variables SASS de revealjs, y [aquí](https://github.com/twbs/bootstrap/blob/main/scss/_variables.scss) las de html Bootstrap. En [html theming](https://quarto.org/docs/output-formats/html-themes.html)
