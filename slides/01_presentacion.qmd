...
| Día                     | Tópico                                 |                    |
+=========================+========================================+====================+
| 9 de julio (martes)     | Presentación\                          | (con slides 01)\   |
|                         | Primeros pasos\                        | (con slides 02)\   |
|                         | Aprendiendo a escribir en QMD\         | (con slides 03)\   |
+-------------------------+----------------------------------------+--------------------+
| 10 de julio (miércoles) | Mi primer web/blog\                    | (con slides 05)\   |
+-------------------------+----------------------------------------+--------------------+
| 15 de julio (lunes)     | Slides con Quarto\                     | (con slides 04)\   |
+-------------------------+----------------------------------------+--------------------+
| 16 de julio (martes)    | Más cosas con Quarto :exclamation:\    | (con slides 06)\   |
+-------------------------+----------------------------------------+--------------------+
...
-   Profesor en la UV (departamento de Análisis Económico) y **entusiasta de R**. En mi web en la UV puedes ver algunos de mis [cursos](https://www.uv.es/pjperez/docencia.html){target="blank"} y [blogs](https://www.uv.es/pjperez/mys_blogs.html){target="blank"}
...
-   Por ejemplo, estos cursos:
    ...
    -   [Intro a la Ciencia de datos con R](https://perezp44.github.io/intro-ds-23-24-web/){target="blank"} (tenéis que ver [los trabajos de los estudiantes](https://perezp44.github.io/intro-ds-22-23-web/07-trabajos_2022-23.html){target="\"blank”"})
    -   [Curso de Introducción a R](https://perezp44.github.io/intro-ds-23-24-web/){target="blank"} (en el SFPIE).
