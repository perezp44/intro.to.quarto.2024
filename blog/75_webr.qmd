...
Así que con Webr **tenemos la posibilidad de ejecutar R en el navegador**. Genial!!, pero ¿cómo funciona?


## `quarto-webr`

[quarto-webr](https://github.com/coatless/quarto-webr) es una extensión de Quarto que facilita la inserción de **chunks de código WebR** en varios formatos de Quarto: HTML, RevealJS, Websites, Blogs, and Books. 
